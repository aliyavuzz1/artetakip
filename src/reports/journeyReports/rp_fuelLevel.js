...
import { getFuelLevel } from '../../services/reportServices/fuelLevelService';

configure({
    enforceActions: "never",
})

const FuelLevel = observer(() => {
  //DatePicker States
  ...
  return (
    <View style={styles.container} >
      <Header
        ...
        centerComponent={{text: i18n.t('fuel_level'), style: styles.heading}}
      />
      <Card>
        <Card.Divider />
        <TouchableOpacity
      ...
      <Button
        ...
        onPress={() => {
          ...
          selectedId 
          ?  getFuelLevel(selectedId,reportDay) 
          : Alert.alert(
            'Hata',
