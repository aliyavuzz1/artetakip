...
const CarsMap1 = observer(() => {
  ...
  const [carMarkersDimension, setCarMarkersDimension] = useState({
    height: 50,
    width: 50,
  });
  ...
  const createLocationRequestAlert = id =>
    Alert.alert(
      'Konum talebi',
      'Aracınızdan anlık konum paketi istenecektir.\nOnaylıyor musunuz?',
      [
        {
          text: 'İptal',
          onPress: () => console.log('Cancel Pressed'),
  ...
  return (
    <>
      <View style={styles.container}>
          ...
          {selectedButton == 4 ? (
            <View
              style={[
                styles.map,
                {
                  height: animatedCarDetailSt
                    ? (windowHeight / 100) * 100
                    : windowHeight / 1.2 -
                      (carDetailViewHeight
                        ? carDetailViewHeight
                        : windowHeight / 2.6),
            ...
            <MapView
              ...
              rotateEnabled={false}>
              {selectedButton !== 4
                ? markerIconCreator(carListStore.mapMarkersType)
                : null}
            </MapView>
          )}
        ...
        <Animated.View
          ...
          style={[
            ...
            {
              transform: [{translateY: animatedCarDetail}],
            },
          ]}>
          <TouchableOpacity
            style={{
            ...
            onPress={() => {
              animatedCarDetailSt ? animatedDetailOut() : animatedDetailIn();
              setAnimatedCarDetailSt(st => !st);
            }}>
            <Text style={{color: '#fff', marginLeft: 10, alignSelf: 'center'}}>
              {i18n.t('show_hide')}
            </Text>
            <FontAwesome
              name={animatedCarDetailSt ? 'angle-up' : 'angle-down'}
              size={30}
              color="#fff"
                ...
                {carListStore.mapST == '2' ? (
                  <View
                    ...
                    <Text
                      allowFontScaling={false}
                      h4
                      h4Style={{fontSize: 17, color: 'green'}}
                      style={{
                        alignSelf: 'flex-end',
                        marginLeft: 10,
                        fontWeight: 'bold',
                ...
                {carListStore.mapST == '9' ? (
                  <View
                    ...
                    <Text
                      allowFontScaling={false}
                      h4
                      h4Style={{fontSize: 17, color: 'black'}}
                      style={{
                        alignSelf: 'flex-end',
                        marginLeft: 10,
                        fontWeight: 'bold',
                ...
                {carListStore.mapST == '1' ? (
                  <View
                    ...
                    <Text
                      allowFontScaling={false}
                      h4
                      h4Style={{fontSize: 17, color: '#FEC260'}}
                      style={{
                        alignSelf: 'flex-end',
                        marginLeft: 10,
                        fontWeight: 'bold',
                ...
                {carListStore.mapCar.DRM2.charAt(7) == 1 ? (
                  <View style={{flexDirection: 'row', alignSelf: 'center'}}>
                    <Text
                      allowFontScaling={false}
                      h4
                      h4Style={{fontSize: 15, color: 'black'}}
                      style={{
                        alignSelf: 'flex-end',
                        marginLeft: 10,
                        fontWeight: 'bold',
              ...
              <View style={{flex: 2}}>
                <Card
                  ...
                  <View style={{justifyContent: 'center'}}>
                    ...
                    {carListStore.mapCar.UYDUSAYISI >= 8 &&
                    carListStore.mapCar.UYDUSAYISI < 13 ? (
                      <View style={{flexDirection: 'row', marginTop: 4}}>
                        <MaterialIcons
                          name="wifi"
                    ...
                    {carListStore.mapCar.ARACMARKASI &&
                    carListStore.mapCar.ARACMARKASI != '-' ? (
                      <View style={{flexDirection: 'row', marginTop: 4}}>
                        <MaterialIcons
                          name="label"
      ...
      {/**SHARE ICON **/}
      <TouchableOpacity
        style={{position: 'absolute', right: -3, top: '24%', padding: 6}}
        onPress={onShare}>
        <View
          style={{
            height: 35,
      ...
      {/**SHOW TRAFFIC ICON **/}
      <TouchableOpacity
        style={{position: 'absolute', right: 0, bottom: '52%', padding: 2}}
        onPress={() => {
        ...
        <View
          ...
          <MaterialCommutyIcons
            name="traffic-light"
            size={26}
            color={showsTraffic ? '#DD5353' : '#ffffff'}
          />
        </View>
      </TouchableOpacity>
      {/**CANBUS ICON **/}
        ...
        <View
          ...
          <Pressable
            ...
            {endDate !== null ? (
              ...
              <Text
                allowFontScaling={false}
                style={{fontSize: 17, color: '#FF6B54', marginLeft: 25}}>
                {i18n.t('notSelected')}
              </Text>
            )}
          </Pressable>
      ...
      <Animated.View
        style={[
          {
            ...
            marginLeft: 0,
            right: (windowWidth / 100) * -45.7,
            top: '30%',
          },
          {transform: [{translateX: animatedMenu}]},
        ]}>
        <View style={{flexDirection: 'row', flex: 1}}>
          <TouchableOpacity
            ...
            onPress={() => {
              animatedMenuStatus ? animatedMenuOut() : animatedMenuIn();
              setAnimatedMenuStatus(!animatedMenuStatus);
            }}>
            <FontAwesome
              name={animatedMenuStatus ? 'angle-right' : 'angle-left'}
              size={30}
              color="#fff"
              style={{alignSelf: 'center'}}
            />
                ...
                <View style={{width: '100%'}}>
                  ...
                  <ScrollView>
                    <View
                      ...
                      <Speedometer
                        speed={parseInt(carListStore.mapCar.DSP)}
                        rpm={carListStore.mapCar.DTO}
                      />
                      <View style={{marginTop: '3%'}} />
                      <CanbusLine
                        title={i18n.t('last_diagnostic')}
                        data={carListStore.mapCar.DRD}
                        icon="gears"
                        filled={carListStore.mapCar.DRD ? true : false}
                      />
                      <CanbusLine
                        title={i18n.t('diagnostic_speed')}
                        data={parseInt(carListStore.mapCar.DSP)}
                        icon="automobile"
                        content={'km/saat'}
                        filled={carListStore.mapCar.DSP ? true : false}
                      />
                      <CanbusLine
                        title={i18n.t('daily_distance')}
                        data={carListStore.mapCar.DTR}
                        icon="road"
                        content={'km'}
                        filled={carListStore.mapCar.DTR ? true : false}
                      />
                      <CanbusLine
                        title={i18n.t('total_distance')}
                        data={carListStore.mapCar.DHD}
                        icon="road"
                        content={'km'}
                        filled={carListStore.mapCar.DHD ? true : false}
                      />
                      <CanbusLine
                        title={i18n.t('rpm_count')}
                        data={carListStore.mapCar.DTO}
                        icon="repeat"
                        content={'/dk'}
                        filled={carListStore.mapCar.DTO ? true : false}
                      />
                      <CanbusLine
                        title={i18n.t('fuel_percent')}
                        data={carListStore.mapCar.DFI}
                        icon="percent"
                        content={'%'}
                        filled={carListStore.mapCar.DFI ? true : false}
                      />
                      <CanbusLine
                        title={i18n.t('daily_spended_gas')}
                        data={carListStore.mapCar.DFD}
                        icon="tint"
                        content={'lt'}
                        filled={carListStore.mapCar.DFD ? true : false}
                      />
                      <CanbusLine
                        title={i18n.t('total_spended_gas')}
                        data={carListStore.mapCar.DFT}
                        icon="tint"
                        content={'lt'}
                        filled={carListStore.mapCar.DFT ? true : false}
                      />
                      <CanbusLine
                        title={i18n.t('engine_temp')}
                        data={carListStore.mapCar.DET}
                        icon="thermometer-full"
                        content={'°C'}
                        filled={carListStore.mapCar.DET ? true : false}
                      />
                      <CanbusLine
                        title={i18n.t('car_weight')}
                        data={carListStore.mapCar.WGH}
                        icon="truck"
                        content={'kg'}
                        filled={carListStore.mapCar.WGH ? true : false}
                      />
                    </View>
                  </ScrollView>
                </View>
